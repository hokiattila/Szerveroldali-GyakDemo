...
<div>
    ...
    <?php endif; ?>
    <?php endif;?>
    <p><i class="tag1"><?=$car["buildYear"]?></i>&nbsp&nbsp<i class="tag1"><?= $car["doorCount"]." ajtós"?></i>&nbsp&nbsp<i class="tag1"><?= $car["color"]?></i></p>
    <p><i class="tag2"><?= $car["power"]." LE"?></i>&nbsp&nbsp<i class="tag2"><?=$car["fuelType"]?></i></p>
