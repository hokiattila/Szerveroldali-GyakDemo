...
<head>
    ...
    <title><?=$viewData["car"]["brand"]." ".$viewData["car"]["modell"]?></title>
</head>
<body class="">
<header>
        ...
        <div class="column-xs-12">
            <nav>
                <ol class="breadcrumb-list">
                    ...
                    <li class="breadcrumb-item"><a href="#"><?=$viewData["car"]["brand"]?></a></li>
                    <li class="breadcrumb-item active"><?= $viewData["car"]["modell"] ?></li>
                </ol>
            </nav>
        </div>
    </div>
    <div class="ketoldal">
                ...
                <div class="column-xs-12 column-md-7">
                    <div class="product-gallery">
                        ...
                        <table>
                            ...
                            <tr>
                                <td>Gyártási év</td>
                                <td><?= $viewData["car"]["buildYear"]?></td>
                            </tr>
                            <tr>
                                <td>Kivitel</td>
                                <td><?=$viewData["car"]["doorCount"] ?></td>
                            </tr>
                            <tr>
                                <td>Szín</td>
                                <td><?=$viewData["car"]["color"]?></td>
                            </tr>
                            <tr>
                                <td>Teljesítmény</td>
                                <td><?=$viewData["car"]["power"]?> Le</td>
                            </tr>
                            <tr>
                                <td>Üzemanyag</td>
                                <td><?=$viewData["car"]["fuelType"]?></td>
                            </tr>
                            <tr>
                                <td>Állapot</td>
                                <td><?=$viewData["car"]["con"] ?></td>
                            </tr>
                        </table>
                    </div>
                </div></div>
        ...
        <div class="egyikoldal">
            <div class="column-xs-12 column-md-5">
                <h1><?=$viewData['car']['brand']." ".$viewData['car']['modell']?></h1>

                <h2><b><?=$viewData["car"]["price"] ?> FT</b></h2>
            ...
            <?php if(isset($_SESSION["username"]) && $_SESSION["userlevel"] == "__1"): ?>
                <form method="post" action="/ottakocsid/car/delete/<?=$viewData["car"]["vin"]?>">
                    <input type="hidden" name="vin" value="<?=$viewData["car"]["vin"]?>"/>
